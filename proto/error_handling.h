...
enum ErrorType { ERROR_TYPE_UNKNOWN = 0, ERROR_INVALID_PACKET, ERROR_INVALID_PACKET_FORMAT, ERROR_API_USAGE };

#define RESET_ERROR_STATE()                                                                                                                \
    if (global_error_state) {                                                                                                              \
        free(global_error_state);                                                                                                          \
        global_error_state = NULL;                                                                                                         \
    }
